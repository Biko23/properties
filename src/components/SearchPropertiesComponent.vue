    ...
    <v-container id="container" fluid>
        <v-row id="property-header">
            ...
            <div id="search-field" style="position: relative">
                <v-autocomplete background-color="white" filled :outlined="true" append-icon="" :autofocus="true" cache-items auto-select-first placeholder="Search Properties" :items="allAutocompletedList" v-model="searchKeyword" :search-input.sync="search" />
        ...
        <v-row id="main-property">
            <v-col cols="12" xl="2" lg="3" md="4" sm="6" xs="12" v-for="(currentProperty, index) in allSearchedResults" :key="index">
                <property-card 
                  ...
                  :onClick="changeIcon" :icon="myIcon" 
                />
            </v-col>
        </v-row>
    </v-container><br />
